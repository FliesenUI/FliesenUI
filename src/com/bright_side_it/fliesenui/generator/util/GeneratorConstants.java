...
public class GeneratorConstants {
    //    public static final String WIDGET_TEXT_VAR_PREFIX = "_widgetText";
    //    public static final String WIDGET_LABEL_VAR_PREFIX = "_widgetLabel";
    public static final String HTML_FILE_ENDING = ".html";
    public static final String JAVASCRIPT_FILE_ENDING = ".js";
    //    public static final String JAVASCRIPT_WIDGET_TEXT_SETTER_SUFFIX = "_widgetText";
    //    public static final String JAVASCRIPT_DTO_SETTER_SUFFIX = "_dto";
    ...
    public static final String GENERATED_CORE_PACKAGE_NAME = "generated.fliesenui.core";
    public static final String GENERATED_WEB_PACKAGE_NAME = "generated.fliesenui.web";
    ...
    public static final String BROWSER_TYPE_FILENAME_PLACEHOLDER = "%browserType%";
    public static final String SINGLE_PAGE_APPLICATION_HTML_FILENAME = "_app_";
    public static final String BROWSER_MODE_JS_VARIABLE = "browserMode";
	public static final String SELECT_BOX_ROW_ID_PARAMETER_NAME = "rowID";
	public static final String FIND_ITEM_WITH_ID_FUNCTION_NAME = "findItemWithID";
	
	public static final String WEB_FILE_UPLOAD_PATH = "fileupload";
	public static final String FILE_UPLOAD_FORM_UPLOADED_FILE_NAME = "uploadedFile";
	public static final String FILE_UPLOAD_FORM_REQUEST_DATA_PARAMETER_NAME = "requestData";

	public static final String DOWNLOAD_FILE_STREAM_PATH_PREFIX = "download/";
