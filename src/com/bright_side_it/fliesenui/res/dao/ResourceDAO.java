...
public class ResourceDAO {
	...
	public enum Resource {
		SCREEN_HTML, FLUI_CSS, ANGULAR_ANIMATE_JS, ANGULAR_AREA_JS, ANGULAR_MATERIAL_CSS, ANGULAR_MATERIAL_JS, ANGULAR_MESSAGES_JS, ANGULAR_JS, FLUI_APPLICATION_JAVA
		, FLUI_SCREEN_JAVA, FLUI_SCRIPT_EXCEPTION_JAVA, FLUI_WEB_VIEW_JAVA, FLUI_MESSAGE_JAVA, FLUI_REPLY_DTO_JAVA, FLUI_REPLY_ABSTRACT_REPLY_JAVA, CODEMIRROR_XML_JS
		, CODEMIRROR_JS, CODEMIRROR_CSS, TEXT_HIGHLIGHTING_JAVA, CURSOR_POS_JAVA, FLUI_UTIL_JAVA, CODEMIRROR_ACTIVE_LINE_JS, CODEMIRROR_MATCHBRACKETS_JS
		, CODEMIRROR_CLOSETAG_JS, CODEMIRROR_MATCHTAGS_JS, CODEMIRROR_XML_FOLD_JS, CODEMIRROR_SHOW_HINT_JS, CODEMIRROR_SHOW_HINT_CSS, CONTEXT_ASSIST_JAVA
		, CONTEXT_ASSIST_CHOICE_JAVA, CONFIRM_DIALOG_PARAMETERS_JAVA, INPUT_DIALOG_PARAMETERS_JAVA, NEW_SCREEN_TEMPLATE, NEW_DTO_TEMPLATE, NEW_PROJECT_PROJECT_TEMPLATE
		, NEW_PROJECT_SCREEN_TEMPLATE, NEW_PROJECT_DTO1_TEMPLATE, NEW_PROJECT_DTO2_TEMPLATE, FLUI_REQUEST_JAVA, NEW_PLUGIN_TEMPLATE, FLUI_IMAGE_STREAM_JAVA
		, FLUI_SCREEN_MANAGER_LISTENER_JAVA, SIMPLE_MANAGER_LISTENER_JAVA, FLUI_WEB_CALL_HANDLER_JAVA, FLUI_WEB_CALL_JAVA, FLUI_FILE_STREAM_JAVA
		, FLUI_CLIENT_PROPERTIES_DTO_JAVA, FLUI_ANDROID_WEB_VIEW_JAVA, HTTP_MULTIPART_REQUEST_READER_JAVA, SHOWDOWN_JS, SHOWDOWN_LICENSE_TEXT, IMAGE_CHECKBOX_CHECKED
		, IMAGE_CHECKBOX_UNCHECKED, ID_LABEL_JAVA, ID_LABEL_IMAGE_ASSET_JAVA, ID_LABEL_IMAGE_ASSET_LIST_JAVA, ID_LABEL_LIST_JAVA, LIST_CHOOSER_PARAMETERS_JAVA
		, LIST_CHOOSER_ITEM_JAVA, KEY_MODIFIER_JAVA, NEW_STRING_RESOURCE, FLUI_ACTION_RECORDING_JAVA, FLUI_SCREEN_REQUEST_JAVA, FLUI_REPLY_ACTION_JAVA
		, FLUI_TEST_CLASS_WRITER_JAVA, FLUI_TEST_REPLY_WRITER_JAVA, JAR_INPUT_STREAM_URL_CONNECTION_JAVA, FLUI_KEY_EVENT_JAVA, FLUI_UTIL_JS, ANGULAR_SANITIZE_JS
		, NEW_COLOR_PALETTE_TEMPLATE, CALLBACK_METHOD_CALL_JAVA, FLUI_ABSTRCT_REPLY_CONTAINER_JAVA
	};
    ...
    private static final String RESOURCE_NAME_ANGULAR_SANITIZE_JS = "angular-sanitize.min.js";
    ...
    private static final String RESOURCE_NAME_NEW_COLOR_PALETTE_TEMPLATE_XML = "NewColorPalette.xml";
	...
	private static final String RESOURCE_NAME_CALLBACK_METHOD_CALL_JAVA = "CallbackMethodCall.java.txt";
	private static final String RESOURCE_NAME_FLUI_ABSTRACT_REPLY_CONTAINER_JAVA = "FLUIAbstractReplyContainer.java.txt";
    ...
    private static Map<Resource, String> createTemplateMap() {
        ...
        map.put(Resource.ANGULAR_SANITIZE_JS, RESOURCE_NAME_ANGULAR_SANITIZE_JS);
        ...
        map.put(Resource.CALLBACK_METHOD_CALL_JAVA, RESOURCE_NAME_CALLBACK_METHOD_CALL_JAVA);
        map.put(Resource.FLUI_ABSTRCT_REPLY_CONTAINER_JAVA, RESOURCE_NAME_FLUI_ABSTRACT_REPLY_CONTAINER_JAVA);
        ...
        map.put(Resource.NEW_COLOR_PALETTE_TEMPLATE, RESOURCE_NAME_NEW_COLOR_PALETTE_TEMPLATE_XML);
    ...
    public void copyResourceToFile(Resource resource, File destFile) throws Exception {
        ...
        if (!destDir.exists()){
        	throw new Exception("Could not create destination directory '" + destDir.getAbsolutePath() + "'");
        }
